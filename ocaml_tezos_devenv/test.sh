...
tezos-client originate contract demo transferring 0 from alice running ~/demo_contracts/demo.tz --init '{Elt "a" 0; Elt "j" 0}' --burn-cap 1
tezos-client originate contract votes transferring 0 from alice running ~/demo_contracts/votes.tz --init '(Pair {} (Pair { Elt "a" 0; Elt "b" 0 } (Pair { Elt "a" "tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb" ; Elt "b" "tz1aSkwEot3L2kmUvcoxzjMomb9mvBNuzFK6" } 1637847000)))' --burn-cap 1
